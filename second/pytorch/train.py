...
inp = input('Do you want to delete that folder?')
if inp == 'y':
    shutil.rmtree('/root/r/model/all_fhd_noDIFFI_RGB_8_256filters_resne') 
...
def example_convert_to_torch(example, dtype=torch.float32,
    ...
    example_torch = {}
    float_names = [
        "voxels", "images1","anchors", "reg_targets", "reg_weights", "bev_map", "importance"
    ]
